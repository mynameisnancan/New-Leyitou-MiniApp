	...
	<view class="page-class">
		...
		<view class="body" :style="{paddingTop:getNavHeight()+'px'}">
			<view class="gradual-bg-color uni-p-lg">
				...
				<!-- 直播间信息 -->
				<view v-if="orderData?.roomInfo"
					class="message-module uni-flex uni-mt-lg uni-border-radius-xl uni-p-sm">
					<view>
				...
				<view class="message-module uni-flex uni-mt-lg uni-border-radius-xl uni-p-sm">
					<view>
						...
						<wd-img width="200rpx" height="100%" :src="orderData?.dyVideoInfo?.videoCoverUrl"
							radius="20rpx">
							<template #error>
								<view class="uni-w-full uni-h-full uni-flex-center uni-font-color-gray error-wrap">加载失败
								</view>
				...
				<view class="message-module uni-flex uni-mt-lg uni-border-radius-xl uni-p-sm">
					...
					<view class="uni-ml-lg uni-text-26">
						<view class="uni-text-warp-2 uni-text-bold">{{orderData?.dyProductInfo?.title || '暂无商品名称'}}
						</view>
						...
						<view class="uni-mt-sm">佣金ROI：{{ orderData?.dataLabel ? compute(orderData,'realROI') :0 }}
						</view>
					</view>
				</view>
			</view>
					...
					<view class="uni-font-color-black uni-text-26">
						<view class="uni-flex uni-justify-between uni-mt-sm">
							...
							<view class="uni-text-bold">
								{{getLabelByValue(leyitou_order_setting,orderData?.marketingGoal)}}
							</view>
						</view>
						...
						<view class="uni-flex uni-justify-between uni-mt-sm">
							<view>出价模式</view>
							<view class="uni-text-bold">
								{{getLabelByValue(leyitou_order_setting,orderData?.deliverySetting?.bid_mode)}}
							</view>
						</view>
						<view class="uni-flex uni-justify-between uni-mt-sm">
							<view>出价方式</view>
							<view class="uni-text-bold">
								{{getLabelByValue(leyitou_order_setting,orderData?.deliverySetting?.bid_type)}}
							</view>
						</view>
						<view class="uni-flex uni-justify-between uni-mt-sm">
							<view>投放时长</view>
				...
				<wd-card custom-style="padding:20rpx">
					<view class="uni-text-26">
						...
						<view class="uni-flex uni-items-center uni-justify-around uni-text-26 uni-mt-lg">
							<view class="uni-flex uni-flex-column uni-items-center">
								<view class="uni-text-bold uni-font-color-black">
									{{ orderData?.dataLabel ? orderData?.dataLabel.payOrderCount : 0}}
								</view>
								<view class="uni-font-color-gray">成交订单数</view>
							</view>
							<view class="uni-flex uni-flex-column uni-items-center">
								<view class="uni-text-bold uni-font-color-black">
									{{ orderData?.dataLabel ? orderData?.dataLabel.payOrderAmount : 0}}
								</view>
								<view class="uni-font-color-gray">成交订单金额</view>
							</view>
							<view class="uni-flex uni-flex-column uni-items-center">
								<view class="uni-text-bold uni-font-color-black">
									{{orderData?.dataLabel ? compute(orderData, 'ROI') : 0}}
								</view>
								<view class="uni-font-color-gray">成交ROI</view>
							</view>
							<view class="uni-flex uni-flex-column uni-items-center">
								<view class="uni-text-bold uni-font-color-black">
									{{ orderData?.dataLabel ? compute(orderData, 'realROI') : 0}}
								</view>
						...
						<view class="uni-flex uni-items-center  uni-text-26 uni-mt-lg">
							<view class="uni-flex uni-flex-column uni-items-center uni-w-1-4">
								<view class="uni-text-bold uni-font-color-black">
									{{ orderData?.dataLabel ? orderData?.dataLabel.showCnt : 0}}
								</view>
								<view class="uni-font-color-gray">展示次数</view>
							</view>
							<view class="uni-flex uni-flex-column uni-items-center uni-w-1-4">
								<view class="uni-text-bold uni-font-color-black">
									{{ orderData?.dataLabel ? compute(orderData, 'CPM') : 0}}
								</view>
								<view class="uni-font-color-gray">千展费用</view>
							</view>
							<view class="uni-flex uni-flex-column uni-items-center uni-w-1-4">
								<view class="uni-text-bold uni-font-color-black">
									{{orderData?.dataLabel ? orderData?.dataLabel.clickCnt : 0}}
								</view>
								<view class="uni-font-color-gray">点击数</view>
							</view>
							<view class="uni-flex uni-flex-column uni-items-center uni-w-1-4">
								<view class="uni-text-bold uni-font-color-black">
									{{ orderData?.dataLabel ? compute(orderData, 'CTR') : 0}}
								</view>
						...
						<view class="uni-flex uni-items-center  uni-text-26 uni-mt-lg">
							...
							<view class="uni-flex uni-flex-column uni-items-center uni-w-1-4">
								<view class="uni-text-bold uni-font-color-black">
									{{ orderData?.dataLabel ? compute(orderData, 'CVR') : 0}}
								</view>
								<view class="uni-font-color-gray">转化率</view>
							</view>
							<view class="uni-flex uni-flex-column uni-items-center uni-w-1-4">
								<view class="uni-text-bold uni-font-color-black">
									{{ orderData?.dataLabel ? compute(orderData, 'CAC') : 0 }}
								</view>
						...
						<view class="uni-flex uni-items-center  uni-text-26 uni-mt-lg">
							<view class="uni-flex uni-flex-column uni-items-center uni-w-1-4">
								<view class="uni-text-bold uni-font-color-black">
									{{ orderData?.dataLabel ? orderData?.dataLabel.dyLike : 0}}
								</view>
								<view class="uni-font-color-gray">点赞次数</view>
							</view>
							<view class="uni-flex uni-flex-column uni-items-center uni-w-1-4">
								<view class="uni-text-bold uni-font-color-black">
									{{ orderData?.dataLabel ? orderData?.dataLabel.dyComment : 0}}
								</view>
								<view class="uni-font-color-gray">评论次数</view>
							</view>
							<view class="uni-flex uni-flex-column uni-items-center uni-w-1-4">
								<view class="uni-text-bold uni-font-color-black">
									{{ orderData?.dataLabel ? orderData?.dataLabel.dyShare : 0 }}
								</view>
								<view class="uni-font-color-gray">分享次数</view>
							</view>
							<view class="uni-flex uni-flex-column uni-items-center uni-w-1-4">
								<view class="uni-text-bold uni-font-color-black">
									{{ orderData?.dataLabel ? orderData?.dataLabel.dyFollow : 0 }}
								</view>
						...
						<view class="uni-flex uni-items-center  uni-text-26 uni-mt-lg">
							<view class="uni-flex uni-flex-column uni-items-center uni-w-1-4">
								<view class="uni-text-bold uni-font-color-black">
									{{ orderData?.dataLabel ? orderData?.dataLabel.dyHomeVisited : 0}}
								</view>
			...
			<wd-message-box selector="wd-message-box-slot">
				<view>
					...
					<wd-cell title="追投时长">
						<wd-input-number prop="renewalDeliverySeconds" clearable
							v-model="addBudQuery.renewalDeliverySeconds" placeholder="请输入追投时长" :min="0" :max="24"
							:step="1" :precision="0" />
					</wd-cell>
				</view>
			</wd-message-box>
