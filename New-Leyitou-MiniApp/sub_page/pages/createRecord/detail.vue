<template>
	<wd-navbar title="投放记录详情" left-arrow @click-left="handleClickLeft" placeholder fixed safeAreaInsetTop></wd-navbar>
	<wd-card title="" custom-class="card-cutom-class">
		...
		<view v-if="detailData?.marketingGoal === 'LIVE_PROM_GOODS'" class="uni-flex uni-items-center uni-justify-between uni-mt-lg">
			<view>视频标题</view>
		...
		<view v-if="detailData?.marketingGoal === 'VIDEO_PROM_GOODS'" class="uni-flex uni-items-center uni-justify-between uni-mt-lg">
		...
		<view v-if="detailSetting?.delivery_setting?.cpa_bid" class="uni-flex uni-items-center uni-justify-between uni-mt-lg">
			<view>优化目标出价</view>
